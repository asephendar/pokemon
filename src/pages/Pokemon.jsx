                        ...
                        <li key={index} className="card shadow-xl">
                            <div className="card-body">
                                <div className="flex flex-col items-center">
                                    <Title Tag="h2" variant="card-title mb-4">
                                        {pokemon.name}
                                        <Eye pokemon={pokemon} onClick={handleShowModal}>
                                            👁
                                        </Eye>
                                    </Title>
                            ...
                            <div className="card-body">
                                <div className="card-actions justify-end">
                                    {pokemonParty.some((p) => p.url === pokemon.url) ? (
                                        <Button variant="btn btn-sm btn-disabled">
                                            In the Team
                                        </Button>
                                    ) : (
                                        <Button pokemon={pokemon} onClick={addToTeam}>
                                            Add to Team
                                        </Button>
                                    )}
                                </div>
                ...
                {showModal && selectedPokemon && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                        <div className="modal-box">
                            <form method="dialog">
                                <Button
                                    variant="btn btn-sm btn-circle btn-ghost absolute right-2 top-2"
                                    onClick={handleCloseModal}
                                >
                                    ✕
                                </Button>
                            </form>
                            <Title Tag="h3" variant="text-2xl font-bold mb-4 text-center">
                            ...
                            <Title Tag="h4" variant="text-xl font-bold mt-4 mb-2">
                                Stats
                            </Title>
                                ...
                                {selectedPokemon.stats.map((stat, index) => (
                                    <div key={index} className="flex-1 min-w-[200px]">
                                        <div className="flex justify-between mb-2 shadow-md py-1 px-1">
                                            <Title Tag="span" variant="font-bold">
                                                {stat.stat.name}
                                            </Title>
                                            <Title Tag="span" variant="font-bold">
                                                {stat.base_stat}
